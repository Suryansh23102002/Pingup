        ...
        <div className='bg-white rounded-lg shadow p-6'>
          ...
          <form className="space-y-4" onSubmit={handleSaveProfile}>
            ...
            <div>
              <label className='block text-sm font-medium text-gray-700 mb-1'>
                Username 
                <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please Enter a username' onChange={()=>setEditForm({...editForm, username: e.target.value})} value={editForm.username} />
              </label>
            </div>
            ...
            <div>
              <label className='block text-sm font-medium text-gray-700 mb-1'>
                Bio 
                <textarea rows={3}  className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please Enter a bio' onChange={()=>setEditForm({...editForm, bio: e.target.value})} value={editForm.bio} />
              </label>
            </div>
